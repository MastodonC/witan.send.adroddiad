(ns witan.send.adroddiad.analysis.leavers-by-ncy
  (:require
    ...
    (vsl/line-and-ribbon-and-rule-plot
     (merge base-chart-spec
            {:data              (-> data
             ...
             :chart-title       "# Ceased EHCP by NCY"
             ...
             :y-title           "# Ceased EHCPs" :y-zero      y-zero                   :y-scale  y-scale
